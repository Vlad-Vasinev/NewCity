...
const watchFiles = () => {
  ...
  watch(paths.srcSvg, svgSpritesMono);
}
...
exports.default = series(clean, pugHtml, scripts, styles, resources, images, svgSprites, svgSpritesMono,  watchFiles);

// exports.backend = series(clean, htmlInclude, scriptsBackend, stylesBackend, resources, images, webpImages, svgSprites)
exports.backend = series(clean, pugHtml, scriptsBackend, stylesBackend, resources, images, svgSpritesMono, svgSprites)

// exports.build = series(toProd, clean, htmlInclude, scripts, styles, resources, images, webpImages, svgSprites, htmlMinify);
exports.build = series(toProd, clean, pugHtml, scripts, styles, resources, images, svgSprites, svgSpritesMono);
